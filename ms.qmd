...
We started with 96 lizards, 48 per species and 12 per treatment per species. However, our final sample size was 81 due to natural mortality (n = 11), failure to complete the training stage (n = 1), or because the number of failed tasks (see above) was higher than 15 (n = 3). The final sample sizes per treatment and species are listed in @fig-results. These animals came from a total of `r deli_clutches` clutches in _L. delicata_ and `r guich_clutches` in _L. guichenoti_.  
