...
We did not find any significant differences between treatments in _L. delicata_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean(deli_ControlCold - deli_CORTCold), 3)`, p- value = `r format_dec(pmcmc(deli_ControlCold - deli_CORTCold), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean((deli_ControlHot + drb_ControlHot) - (deli_CORTHot + drb_CORTHot)), 3)`, p- value = `r format_dec(pmcmc((deli_ControlHot + drb_ControlHot) - (deli_CORTHot + drb_CORTHot)), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean((deli_ControlHot + drb_ControlHot) - (deli_ControlCold + drb_ControlCold)), 3)`, p-value = `r format_dec(pmcmc((deli_ControlHot + drb_ControlHot) - (deli_ControlCold + drb_ControlCold)), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean((deli_CORTHot + drb_CORTHot) - (deli_CORTCold + drb_CORTCold)), 3)`, p-value = `r format_dec(pmcmc((deli_CORTHot + drb_CORTHot) - (deli_CORTCold + drb_CORTCold)), 3)`) (see @Figdeli) or _L. guichenoti_ ('Control-Cold' - 'CORT-Cold' = `r format_dec(mean((guich_ControlCold + grb_ControlCold) - (guich_CORTCold + grb_CORTCold)), 3)`, p- value = `r format_dec(pmcmc((guich_ControlCold + grb_ControlCold) - (guich_CORTCold + grb_CORTCold)), 3)`; 'Control-Hot' - 'CORT-Hot' = `r format_dec(mean((guich_ControlHot + grb_ControlHot) - (guich_CORTHot + grb_CORTHot)), 3)`, p- value = `r format_dec(pmcmc((guich_ControlHot + grb_ControlHot) - (guich_CORTHot + grb_CORTHot)), 3)`; 'Control-Hot' - 'Control-Cold' = `r format_dec(mean((guich_ControlHot + grb_ControlHot) - (guich_ControlCold + grb_ControlCold)), 3)`, p-value = `r format_dec(pmcmc((guich_ControlHot + grb_ControlHot) - (guich_ControlCold + grb_ControlCold)), 3)`; 'CORT-Hot' - 'CORT-Cold' = `r format_dec(mean((guich_CORTHot + grb_CORTHot) - (guich_CORTCold + grb_CORTCold)), 3)`, p-value = `r format_dec(pmcmc((guich_CORTHot + grb_CORTHot) - (guich_CORTCold + grb_CORTCold)), 3)`) (see @Figguich). We did not find any effect of incubation temperature (_L. delicata_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((deli_CORTHot + deli_ControlHot + drb_CORTHot + drb_ControlHot) - (deli_CORTCold + deli_ControlCold + drb_CORTCold + drb_ControlCold)),3)`, p-value = `r format_dec(pmcmc((deli_CORTHot + deli_ControlHot + drb_CORTHot + drb_ControlHot) - (deli_CORTCold + deli_ControlCold + drb_CORTCold + drb_ControlCold)),3)`; _L. guichenoti_: 'Hot' learning slope - 'Cold' learning slope = `r format_dec(mean((guich_CORTHot + guich_ControlHot + grb_CORTHot + grb_ControlHot) -(guich_CORTCold + guich_ControlCold + grb_CORTCold + grb_ControlCold)),3)`, p-value = `r format_dec(pmcmc((guich_CORTHot + guich_ControlHot + grb_CORTHot + grb_ControlHot) -(guich_CORTCold + guich_ControlCold + grb_CORTCold + grb_ControlCold)),3)`) or the hormone (_L. delicata_: 'Control' learning slope - 'CORT' learning slope = `r format_dec(mean((deli_ControlCold + deli_ControlHot + drb_ControlCold + drb_ControlHot) - (deli_CORTCold + deli_CORTHot + drb_CORTCold + drb_CORTHot)), 3)`, p-value = `r format_dec(pmcmc((deli_ControlCold + deli_ControlHot + drb_ControlCold + drb_ControlHot) - (deli_CORTCold + deli_CORTHot + drb_CORTCold + drb_CORTHot)), 3)`;_L. guichenoti_: 'Control' learning slope - 'CORT' learning slope = `r format_dec(mean((guich_ControlCold + guich_ControlHot + grb_ControlCold + grb_ControlHot)-(guich_CORTCold + guich_CORTHot + grb_CORTCold + grb_CORTHot)), 3)`, p-value = `r format_dec(pmcmc((guich_ControlCold + guich_ControlHot + grb_ControlCold + grb_ControlHot)-(guich_CORTCold + guich_CORTHot + grb_CORTCold + grb_CORTHot)), 3)`) when groups were pooled. Finally, we did not find any significant differences when we compared the estimated slopes between species for the reversal task (_L. delicata_ - _L. guichenoti_ = `r format_dec(mean((deli_CORTCold + deli_ControlCold + deli_CORTHot + deli_ControlHot + drb_CORTCold + drb_ControlCold + drb_CORTHot + drb_ControlHot) - (guich_CORTCold + guich_ControlCold + guich_CORTHot + guich_ControlHot + grb_CORTCold + grb_ControlCold + grb_CORTHot + grb_ControlHot)), 3)`, p-value = `r format_dec(pmcmc((deli_CORTCold + deli_ControlCold + deli_CORTHot + deli_ControlHot + drb_CORTCold + drb_ControlCold + drb_CORTHot + drb_ControlHot) - (guich_CORTCold + guich_ControlCold + guich_CORTHot + guich_ControlHot + grb_CORTCold + grb_ControlCold + grb_CORTHot + grb_ControlHot)), 3)`). 
