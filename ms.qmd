...
**Our results suggest that prenatal CORT and temperature do not affect the behavioural flexibility of _L. delicata_ and _L. guichenoti_. We did not find any significant differences between treatments in the reversal task, and when we compared the estimated slopes between species. This is in contrast with our predictions, as we expected that _L. guichenoti_ would be more impacted by the prenatal environment than _L. delicata_. We also expected that prenatal CORT would impair the performance of the lizards in the task, and that higher temperatures would improve it. However, we did not find any evidence of this.

They learn on average, as shown by positive slopes that do not vary when only those "superperformers" are employed in the analyses.

Why no effect of treatment? 
    What is expected from CORT? Other studeis showing no effects or the opposite: @szuran_water_1994; @crino_corticosterone_2014-learn; @farrell_developmental_2015-learn; @bebus_associative_2016. Multiple factors may affect this results, including the dose of CORT, the time of exposure, and the species. Reversal?? Check @lui2017chronic and @jonson1976effect.

    What is expected from temperature? Other studies showing no effects or the opposite: @abayarathna_effects_2020; @dayananda. But these studies are in other species and with temperatures above the natural range. None of them reversal?? Only reversal done with criterion, so cold were not tested

    Selective sieve? No effects because is too simple?

Why no differences between species?
    Other papers finding no effects in learning: @bezzina2014does. Here they did not learn at all, too complex? Related with absence of treatment effects?

    No differences in treatment effects

Conclusions (sum up the discussion)**
