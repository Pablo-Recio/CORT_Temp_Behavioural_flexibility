...
## Introduction
Behavioural flexibility, **the ability to adapt behaviour to changing environments** (**REFS**), is considered crucial for invasion success [@sol2002behavioural]. In general, species with higher behavioural flexibility are more likely to survive and establish in new habitats (**REFS**) as behaving flexibly enhances their capacity to exploit new resources and face new challenges (**REFS**). The adaptive flexibility hypothesis posits that increased behavioral flexibility can be advantageous during the stages of introduction and spread or invasion, but less relevant during the establishment of a population (@writght_et_al_2010).      
