...
## Introduction
Behavioural flexibility describes the ability of individuals to adjust behaviour adaptively in response to changes in the internal or external environment [@brown2010behavioral]. It comprises a suite of behaviours, including problem-solving or innovation [@brown2010behavioral], that can be beneficial for adapting to novel circumstances [@szabo2020can; @szulkin2020urban]. Species with greater behavioural flexibility are expected to be more resilient to environmental changes because behaving flexibly is predicted to be crucial for exploiting new resources and facing new challenges [@wright2010behavioral; @chapple2012can; @szabo2020can; @szulkin2020urban]. For example, shifting hydration activity to day hours instead of hydrating during the night alone, allows cane toads to survive in semi-arid regions of Australia [@webb2014behavioural]; and succesful colonisation of new environments by birds is related to higher frequency of foraging innovations [@sol2000behavioural]. Although there is limited understanding of the physiological mechanisms involved in animals' ability to behave flexibly, relative brain size has been shown to be a good predictor of behavioural flexibility in mammals, birds, reptiles and amphibians [@sol2000behavioural; @sol2008brain; @amiel_smart_2011]. This suggests that behavioural flexibility is likely to be underpinned by neural mechanisms, and that alterations in these mechanisms may impact animals' ability to respond to novel situations. In this sense, the brain is considered especially sensitive to environmental changes during the early stages of development [@zhu_prenatal_2004], creating uncertainty about how the conditions faced during early life stages might impact behavioural flexibility.  

The conditions in which the organisms develop can be altered by the circumstances faced by the parents. **For example** . Under stressful situations, animal's sensory systems detect and transmit environmental signals to instigate adaptive physiological and behavioural adjustments – responses that are mediated by glucocorticoids (GCs) [@sapolsky_how_2000]. Glucocorticoids can be transmitted to offspring and influence their phenotype and development through transgenerational effects [@Crino_2023]. In addition to the environments experienced by parents, offspring also experience potentially stressful environmental conditions that can interact with or amplify parental effects. For instance, coping stress style is related to nest-site selection in eider ducks [@seltmann2014boldness], and snapping turtles select nest micro-habitats 2ºC colder in areas with high degree of human disturbance [@kolbe2002impact]. This way, parental effects like transmitted GCs, are predicted to interact with other environmental factors like temperature to influence the offspring phenotype. Furthermore, both GCs and temperature are expected to exert potent effects on brain development [@jonson1976effect; @coomber_independent_1997; @zhu_prenatal_2004; @amiel_effects_2017] and cognition [@clark_colour_2014; @lui2017chronic]. [**EXAMPLE Gcs and beh flexibility + EXAMPLE temp and beh flexibility**]. Although behaving flexibly is essential for coping with environmental changes, little is known about how developmental GCs and temperature impact behavioural flexibility.  

Here, we studied the effects of prenatal temperature and corticosterone (CORT) (the main GC in reptiles) [@Crino_2023], on behavioural flexibility in two species of reptiles, the delicate skink (_Lampropholis delicata_) and the common garden skink (_L. guichenoti_). _Lampropholis delicata_ has been successful in colonising different areas around the globe [@baker1979rainbow; @chapple2013divergent; @chapple2015deliinvLHI], but the same is not true of _L. guichenoti_ despite the two species having similar life-histories and overlapping distributions [@chapple_know_2011; @chapple_biology_2014]. [**IMPORTANCE OF BEHAVIOURAL FLEXIBILITY ON INVASION SUCCESS**] Additionally, early environments are known to affect suites of morphological and behavioural traits differently in each species [@carrasco2023maternal; @kar2023heritability], but the interactive role of maternal CORT and early temperatures has not yet been explored. Differences in the relative impact of early environments on behavioural flexibility may help explain differing invasion success between the two species. [**How can environment affect differently based on invassive success??**]. In this regard, we predict that _L. delicata_, on average, will perform more proficiently in the task compared to _L. guichenoti_. We also anticipate prenatal CORT and temperature to affect the behavioural flexibility of both species, and that _L. guichenoti_ will be more impacted by the prenatal environment than _L. delicata_. More specifically, we predict cold incubation temperatures and CORT treatment to impair behavioural flexibility (**REFs**), and that the combination of both treatments to have the most detrimental effect on behavioural flexibility.  
