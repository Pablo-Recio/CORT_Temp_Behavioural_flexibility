...
#
#| label: fig-Methods
#| fig.cap: "Experimental design of early environment manipulation and learning tasks. On top, the early environment manipulation for both species. Center, the habituation phase with the respective three different stages. On the bottom, the associative and reversal tasks; white lids show the ramps where the food reward was not accessible."
